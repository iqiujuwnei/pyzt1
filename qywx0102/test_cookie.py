...
class Testcookie:
    ...
    def test_add_cookie(self):
        ...
        while True:
            self.driver.refresh()
            asert = WebDriverWait(self.driver, 20).until(
                expected_conditions.visibility_of_element_located((By.XPATH, '//*[@id="menu_profile"]')))
        ...
        WebDriverWait(self.driver, 20).until(
            expected_conditions.presence_of_element_located((By.XPATH, '//*[@class="js_go_template_import"]')))
        # 点击'上传文件'上传自己本地文件
        self.driver.find_element(By.ID, 'js_upload_file_input').send_keys(
            "/Users/zhangtao/PycharmProjects/pyzt1/qywx0102/zttest.xls")
        # 显示等待上传'文件名'是否可见
